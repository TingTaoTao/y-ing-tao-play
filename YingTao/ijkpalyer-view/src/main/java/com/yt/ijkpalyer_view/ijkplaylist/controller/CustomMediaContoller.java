package com.yt.ijkpalyer_view.ijkplaylist.controller;
...
import com.yt.ijkpalyer_view.ijkplay.media.IMediaController;
...
public class CustomMediaContoller implements IMediaController {
    ...
    public void start() {
        pauseImage.setVisibility(View.GONE);
        itemView.setVisibility(View.GONE);
        play.setImageResource(R.drawable.ll_video_stop_btn);
        progressBar.setVisibility(View.VISIBLE);
    }

    public void pause(){
        play.setImageResource(R.drawable.ll_video_play_btn);
        videoView.pause();
...
//                        statusChange(STATUS_PLAYING);
        ...
        sound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isSound) {
                    //静音
                    sound.setImageResource(R.drawable.ll_sound_mult_icon);
                    audioManager.setStreamMute(AudioManager.STREAM_MUSIC, true);
                } else {
                    //取消静音
                    sound.setImageResource(R.drawable.ll_sound_open_icon);
                    audioManager.setStreamMute(AudioManager.STREAM_MUSIC, false);
                }
                isSound = !isSound;
            }
