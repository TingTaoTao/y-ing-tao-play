package com.yt.ijkpalyer_view.ijkplaylist.adapter;
...
import com.yt.ijkpalyer_view.ijkplaylist.bean.VideoItemData;
...
public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.VideoViewHolder> {
    ...
    public VideoAdapter.VideoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ll_item_video, parent, false);
