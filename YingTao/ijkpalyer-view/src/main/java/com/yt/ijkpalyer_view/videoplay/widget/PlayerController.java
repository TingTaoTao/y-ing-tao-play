...
public class PlayerController extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
     ...
     * 设置播放状态
     *
     * @param curPlayState 参考 {@link com.yt.ijkpalyer_view.videoplay.constant.PlayState}
     */
     ...
     *                    <ol>
     *                    <li>{@link com.yt.ijkpalyer_view.videoplay.util.OrientationUtil#HORIZONTAL HORIZONTAL}</li>
     *                    <li>{@link com.yt.ijkpalyer_view.videoplay.util.OrientationUtil#VERTICAL VERTICAL}</li>
     *                    </ol>
     */
