package com.yt.ijkpalyer_view.videoplay.activity;
...
import com.yt.ijkpalyer_view.videoplay.widget.VideoPlayer;
...
public class ZZPlayerDemoActivity extends Activity {
    ...
    private void initView() {
        ...
        mVp.setIconShrink(R.drawable.zz_shrink);
        //隐藏/显示控制栏时间值信息
        // mVp.hideTimes();
        // mVp.showTimes();
        // 自定义加载框图标
        mVp.setIconLoading(R.drawable.zz_loading_red);

        // 设置进度条样式
        mVp.setProgressThumbDrawable(R.drawable.zz_progress_thumb);
        mVp.setProgressLayerDrawables(R.drawable.zz_biz_video_progressbar);//自定义的layer-list
        // mVp.setProgressLayerDrawables(0, 0, R.drawable.zz_shape_progress);//逐层设置,0的话表示保持默认
